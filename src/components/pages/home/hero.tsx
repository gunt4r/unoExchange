        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56 lg:pb-24">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="mb-4 inline-block rounded-full border border-green-500/20 bg-green-500/5 px-4 py-2">
              <span className="text-sm text-green-400">Trusted by our customers</span>
            </div>
          </div>
          <div className="text-center">
            ...
            <p className="mt-8 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
              Low fees, real-time rates, and bank-grade security for fast and reliable fiat currency exchange.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <MyLink
                href="#converter"
                onClick={handleSmoothScroll}
                classNames="rounded-md border border-green-500/50 bg-green-500/15 px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs hover:bg-green-400/20 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Start Converting
              </MyLink>
              <MyLink href="#" classNames="text-sm/6 font-semibold text-white">
                Learn more
                {' '}
